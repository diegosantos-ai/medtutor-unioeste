      ...
      <div className="bg-white/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-white/20 p-8 max-w-lg w-full relative z-10 transition-all duration-300">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-16 text-center space-y-6 animate-fade-in">
            ...
            <div>
              <h3 className="text-2xl font-bold text-surface-900 mb-2">Construindo sua Aprovação...</h3>
              <p className="text-surface-600 max-w-xs mx-auto">A IA está analisando seus dados para criar o plano perfeito para a UNIOESTE.</p>
            </div>
          </div>
        ) : (
            ...
            {step === 1 && (
              <div className="space-y-8 animate-slide-up">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-surface-600 text-lg">Para criar seu plano personalizado, primeiro precisamos te conhecer.</p>
                </div>
              ...
              <div className="space-y-6 animate-slide-up">
                ...
                <div className="grid grid-cols-2 gap-3 max-h-60 overflow-y-auto pr-1">
                  {subjects.map(sub => (
                    ...
                    >
                      {sub}
                      {difficulties.includes(sub) && <CheckCircle size={14} />}
                    </button>
                  ))}
                </div>
