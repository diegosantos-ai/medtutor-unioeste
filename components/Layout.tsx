...
const Layout: React.FC<LayoutProps> = ({ children, currentView, setView, userName }) => {
  ...
  return (
    <div className="min-h-screen bg-surface-50 flex flex-col md:flex-row">
      ...
      `}>
        <div className="p-6">
          <h1 className="text-2xl font-bold text-brand-600 hidden md:block mb-1">MedTutor</h1>
          <p className="text-sm text-surface-500 hidden md:block mb-8">Olá, {userName}</p>
